...
- 📈 **Мониторинг**: автоматическая проверка доступности бэкендов каждые 60 секунд
- 🎯 **Автоматическое переключение**: во время активной сессии сервер проверяет текущий прокси каждые 5 секунд и переключается на лучший, если RTT > 800мс или прокси недоступен
